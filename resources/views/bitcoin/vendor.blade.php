...
@section('content')
    ...
    <div class="vendor" style="font-size: 16px; padding-left: 30px;">
        <p>Follow the instructions below to be a vendor</p>
        * Provide your Legal Full name and Address <br>
        * It is government issued (e.g. passport,National ID card, Voters Card). <br>
        * It must be valid (not expired), legible and in color. <br>
