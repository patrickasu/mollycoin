    ...
    <div class="row">
        <div class="col-md-12">    
            <div class="bitcoin-header">
                <h2 class="">Bitcoin! A New Kind of Money</h2>
            </div> 
        </div>
    </div> 
</div>
...
<div class="container-fluid"> 
    <div class="row">
        <div class="col-md-12">    
            <div class="bitcoin-header">
                <h2 class="bitcoin-main-header">Best Rate! Buy Bitcoin at Different Price</h2>
            </div> 
        </div>
    </div> 
</div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="background-img">
                    <div class="d-flex flex-column">
                        <p class="desc">Start your transactions in bitcoin</p>
            ...
            <div class="col-md-6">    
                <div class="d-flex flex-column">
                    <h2 class="about-3-desc">Over 300 ways to buy and sell bitcoin</h2>
                    <div class="bullets">
                        <i class="fas fa-check"></i>
                        <p class="icon-desc">Cashapp Payment</p> 
                    </div>
                    <div class="bullets">
                        <i class="fas fa-check"></i>
                        <p class="icon-desc">PayPal</p> 
                    </div>
                    <div class="bullets">
                        <i class="fas fa-check"></i>
                        <p class="icon-desc">Gift Cards</p> 
                    </div>
                    <div class="bullets">
                        <i class="fas fa-check"></i>
                        <p class="icon-desc">Online Transfer</p> 
                    </div>
                    <div class="bullets">
                        <i class="fas fa-check"></i>
                        <p class="icon-desc">Digital Currencies</p> 
                    </div>
                    <a class="about-btn" href="/login">TRADE NOW</a>
                </div>   
            </div>
